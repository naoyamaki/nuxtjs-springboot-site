...
public class ReviewRecord extends UpdatableRecordImpl<ReviewRecord> implements Record9<Integer, Integer, String, String, Byte, Byte, LocalDateTime, LocalDateTime, Byte> {
    ...
    @Override
    public Row9<Integer, Integer, String, String, Byte, Byte, LocalDateTime, LocalDateTime, Byte> valuesRow() {
    ...
    @Override
    public ReviewRecord value5(Byte value) {
        setCategoryId(value);
        return this;
    }

    @Override
    public ReviewRecord value6(Byte value) {
        setStatus(value);
        return this;
    }
    ...
    @Override
    public ReviewRecord values(Integer value1, Integer value2, String value3, String value4, Byte value5, Byte value6, LocalDateTime value7, LocalDateTime value8, Byte value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ReviewRecord(Integer id, Integer userId, String title, String body, Byte categoryId, Byte status, LocalDateTime insertDate, LocalDateTime updateDate, Byte deleteFlag) {
        super(Review.REVIEW);
